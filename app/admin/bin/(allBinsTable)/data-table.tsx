...
import AllBinsTableStatusDropdown from "../../components/allBinsStatusFilterDropdown";
...
export function DataTable<TData, TValue>({
  ...
  const [showFunctional, setShowFunctional] = React.useState<Checked>(false);
            ...
            <DropdownMenuContent className="w-56">
              ...
              <DropdownMenuCheckboxItem
                ...
                onCheckedChange={() => {
                  table
                    .getColumn("status")
                    ?.setFilterValue("UNDER_MAINTENANCE");
                  setShowUnderMaintenance(!showUnderMaintenance);
                }}
              >
                Under Maintenance
              </DropdownMenuCheckboxItem>
