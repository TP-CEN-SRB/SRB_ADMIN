...
// --- Add this to the very bottom of action/bin.ts ---
...
export const fetchChartsData = async (startDate?: Date, endDate?: Date, filter?: string) => {
  const [
    DBBarChartData,
    DBPieChartData,
...
// 🚀 This is the main function your client component will call
