...
// Mirrors MemberTransactionHeader (member/transaction/[id]/header.tsx).
...
interface StoreTransactionHeaderProps {
  storeName: string
  currentPage: number
  currentLimit: number
  totalPages: number
...
export function StoreTransactionHeader({
  storeName,
  currentPage,
  currentLimit,
  totalPages,
  totalCount,
}: StoreTransactionHeaderProps) {
