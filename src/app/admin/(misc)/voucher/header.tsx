...
const sorts = [
  ...
  { label: "Points Low-High", value: "pointsAsc" },
  { label: "Points High-Low", value: "pointsDesc" },
...
export function VoucherHeader({ currentPage, currentLimit, totalPages, totalCount }: VoucherHeaderProps) {
